    ...
    <?php
        ...
        <form action="" method="post">
            <table align='center' width='400' cellpadding='5' cellspacing='5'>
                <th colspan="2">
                    <font size="5"><i>XOÁ THÔNG TIN SIZE</i></font>
                </th>
                <tr>
                    <td>Mã size: </td>
                ...
                <tr>
                    <td>Size: </td>
                    <td><input type="text" name="Size" size="20" value="<?php echo $size; ?>" disabled /></td>
                </tr>
                <tr>
        ...
        <?php
        if (isset($_POST["xoa"])) {
            $sql = "DELETE FROM SizeGiay
                WHERE MaSize='$maSize'";
            $result = mysqli_query($conn, $sql);
            if ($result != false) {
                echo "<p align='center'>Đã xoá size $maSize</p>";
            }
        }
        ?>
