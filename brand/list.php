...
<head>
    ...
    <title>Thông tin hãng giày</title>
</head>
<body>
    ...
    echo "<h2 align='center'><i>THÔNG TIN HÃNG GIÀY</i></h2>";
    echo "<h4 align='center'><a href='add.php'>Thêm hãng giày mới</a></h4>";
    echo "<table>";
    echo '<thead>
    <tr>
        <th>STT</th>
    ...
    if (mysqli_num_rows($result) <> 0) {
        ...
        while ($rows = mysqli_fetch_row($result)) {
            ...
            echo "<tr> 
                ...
                <td>$rows[0]</td>
                <td>$rows[1]</td>
                <td><a href='edit.php?MaHG=$rows[0]'>Sửa</a></td>
                <td><a href='delete.php?MaHG=$rows[0]'>Xoá</a></td>
            </tr>";
            $stt += 1;
        } //while 
        echo "</tbody></table>";

        $re = mysqli_query($conn, 'SELECT * FROM HangGiay');
